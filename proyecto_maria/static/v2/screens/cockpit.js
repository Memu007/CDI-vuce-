    ...
    function renderTabla(ops) {
        ...
        body.innerHTML = ops.map(function (op) {
            return '<tr>' +
                ...
                '<td class="ck-actions">' +
                    '<button type="button" class="btn-ghost btn-sm ck-share-btn" data-op="' + CDI.escapeHtml(op.id) + '" aria-label="Copiar link público" title="Compartir estado con el cliente">' +
