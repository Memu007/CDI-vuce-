...
- **Organizaciones paso 3 (2026-06-21):** billing por organización. Helper `_get_billing_entity` decide si leer billing de org o user. `billing_me`, `require_active_billing`, `record_operation_created`, checkout, topup y webhook adaptados. 6 columnas nuevas en organizations (migración idempotente). Fixes del audit: mínimo 8 chars password en create_org, registro con invite_token optimizado (1 query en vez de 2). Próximo paso: UI.
