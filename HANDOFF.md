...
- **Organizaciones paso 2 (2026-06-21):** 5 endpoints nuevos (create, mine, invite, validate token, remove member). Registro acepta invite_token. Verificado end-to-end: crear estudio, login, ver org, invitar. Próximo paso: billing por organización + UI.
