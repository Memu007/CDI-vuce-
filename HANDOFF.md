...
- **Organizaciones paso 1 (2026-06-21):** modelos `Organization` + `Invitation` + `organization_id` en `User`. 3 migraciones idempotentes creadas y verificadas. No cambia comportamiento existente. Próximo paso: endpoints de invite + registro con token.
