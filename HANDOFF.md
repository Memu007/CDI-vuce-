...
- **SEGURIDAD CERRADA (2026-06-21):** Score 8/10. 36 tests locales + 17 Railway + 3 prompt injection + verificación visual = todos PASS. Sin cambios de código pendientes. Fase 2: blacklist jti, reset/refresh password, PDF bomb limit, migrar inline scripts, sacar unsafe-inline, actualizar aiohttp/pillow/pyopenssl, test XSS end-to-end cuando Tarifar esté activo.
