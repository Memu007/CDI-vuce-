...
- **Inferencia masiva desde una fila (2026-07-12):** si los seleccionados contienen una única posición SIM completa, la barra masiva la precarga automáticamente (incluido DC); “Asignar SIM y unir” la copia a los ítems vacíos/incompletos y crea el grupo. Dos posiciones completas diferentes requieren elección manual y no se unen silenciosamente.
